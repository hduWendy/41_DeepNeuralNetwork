...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile = "D:\\H D U\\VS\\深度学习数据集文件\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\H D U\\VS\\深度学习数据集文件\\yolov3.cfg";
	//权重
	String weights = "D:\\H D U\\VS\\深度学习数据集文件\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\H D U\\VS\\深度学习数据集文件\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\H D U\\VS\\深度学习数据集文件\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
